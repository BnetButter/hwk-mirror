...
class NetworkStatus(tk.Frame):
    ...
    def __init__(self, parent, font=None, **kwargs):
        ...
        self.network_indicator = lib.StatusIndicator(self, "Network", bd=1, width=8, font=font)
        # green if POS device connected to server
        self.server_indicator = lib.StatusIndicator(self,  "Server", bd=1, width=8, font=font)
        # green if Display device connected to server
        self.display_indicator = lib.StatusIndicator(self, "Display0", bd=1, width=8, font=font)
        self.display_indicator1 = lib.StatusIndicator(self, "Display1", bd=1, width=8, font=font)
        ...
        self.display_indicator1.grid(row=0, column=3, **grid_kwargs)
    ...
    def update(self):
        ...
        client0 = False if client is None else "Display0" in client
        client1 = False if client is None else "Display1" in client
        self.display_indicator.set(client0)
        self.display_indicator1.set(client1)
